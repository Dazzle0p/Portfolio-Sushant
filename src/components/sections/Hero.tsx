    ...
    <header className="relative overflow-hidden pt-24 pb-24">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(600px circle at 30% 30%, hsl(190 95% 42% / .25), transparent 60%)",
          }}
        />
        <div
          className="absolute -bottom-24 -right-24 h-[520px] w-[520px] rounded-full blur-3xl"
          style={{
            background:
              "radial-gradient(600px circle at 70% 70%, hsl(265 85% 62% / .25), transparent 60%)",
          }}
        />
      </motion.div>
      ...
      <div className="container relative z-10">
        <div className="mx-auto max-w-5xl text-center">
          <motion.h1
            ...
            style={{
              backgroundImage:
                "linear-gradient(90deg, hsl(0 0% 100%), hsl(0 0% 100% / .5), hsl(0 0% 100%))",
          ...
          >
            Building cool stuff on the internet since… well, not that long ago.
          </motion.p>
          ...
          >
            {[
              {
                title: "Curious",
                desc: "Seeker of ideas",
                badge: "Explorer",
              },
              {
                title: "Learner",
                desc: "Evolving every day",
                badge: "Growth",
              },
              {
                title: "Crafter",
                desc: "Precision in creation",
                badge: "Precision",
              },
            ].map((c, i) => (
              <motion.div
